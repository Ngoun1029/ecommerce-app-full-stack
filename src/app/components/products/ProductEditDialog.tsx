...
export default function ProductEditDialog({
  ...
  const addColor = () => {
    ...
    if (!form.color.includes(colorInput)) {
      setForm((prev) => ({
        ...prev,
        color: [...prev.color, colorInput],
      }));
    }
  ...
  const removeColor = (value: string) => {
    setForm((prev) => ({
      ...prev,
      color: prev.color.filter((c) => c !== value),
    }));
  };
        ...
        <div className="space-y-6 px-6 py-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <input
                ...
                placeholder="Enter color (red or #fff)"
              ...
              <button
                type="button"
                onClick={addColor}
                className="px-4 rounded-xl bg-primary text-black text-sm"
              >
                Add
              </button>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              {form.color.map((c, i) => (
                <div
                  key={i}
                  className="flex items-center gap-2 px-3 py-1.5 rounded-full border bg-gray-100 text-sm"
                >
                  <span
          ...
          <div className="flex items-center justify-between rounded-xl border bg-gray-50 px-4 py-3">
            <div>
              ...
              <p className="text-xs text-gray-500">Enable / Disable product</p>
            </div>
